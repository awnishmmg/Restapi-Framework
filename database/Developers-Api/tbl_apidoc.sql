...
(9, NULL, NULL, '200', 'GET', 'product_metadata/is_featured', 'How to Get Meta data of any Product according to rating ', 'keyname = product_metadata/?', 'json', 'Note That keyname = product_metadata/?\r\nhere ? = is_featured,is_hotdeal etc according to url_keys\r\n');
...
--
ALTER TABLE `tbl_apidoc`
  MODIFY `apidoc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
COMMIT;
